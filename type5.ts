...
let x = [1,2]; //x est de type number[] : ne peut contenir que des entiers
x[2] = 3;
...
let z : (number | string)[] = []; //tableau vide contenant des entiers ou des décimauw
...
let t : [number,string] = null; //tuple dont le T1 est un nombre et T2 est un string
